...
<div class="container">
    <form action="/kich-thuoc/store" method="post">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="ma" value="${kichThuoc.ma}">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="ten" value="${kichThuoc.ten}">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="trangThai">
                <option value="1" ${kichThuoc.trangThai == 1 ? "selected":""}}>Đang hoạt động</option>
                <option value="0" ${kichThuoc.trangThai == 0 ? "selected":""}>Ngừng hoạt động</option>
            </select>
        </div>
        <div class="mb-3">
