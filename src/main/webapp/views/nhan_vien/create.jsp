...
<div class="container">
    <form action="/nhan-vien/store" method="post">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="maNV" value="${nhanVien.maNV}">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="tenDangNhap" value="${nhanVien.tenDangNhap}">
        ...
        <div class="mb-3">
            ...
            <input class="form-control" type="text" name="matKhau" value="${nhanVien.matKhau}">
