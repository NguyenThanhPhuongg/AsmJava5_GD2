...
<body>
<h1 class="text-center">Quản Lý Khach hang</h1>
<div class="container">
    <form action="/khach-hang/store" method="post">
        <div class="mb-3">
            <label class="form-label">Ma KH</label>
            <input type="text" class="form-control" name="maKH" value="${khachHang.maKH}">
        ...
        <div class="mb-3">
            ...
            <select class="form-select" name="trangThai">
                <option value="1" ${khachHang.trangThai == 1 ? "selected":""}>Đang hoạt động</option>
