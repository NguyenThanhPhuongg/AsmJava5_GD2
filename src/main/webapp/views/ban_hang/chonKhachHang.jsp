    ...
    <table class="table">
        ...
        <c:forEach items="${listKhachHang}" var="kh">
            <tr>
                ...
                <td>
                    <a href="/ban-hang/chonKhachHang/${kh.id}">
                        <button class="btn btn-danger">Chon</button>
                    </a>
                </td>
            </tr>
        </c:forEach>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <li class="page-item <c:if test='${currentPage == 1}'>disabled</c:if>'">
                <a class="page-link" href="?page=1&limit=${pageSize}" aria-label="First">
            ...
            <li class="page-item <c:if test='${currentPage == totalPages}'>disabled</c:if>'">
                <a class="page-link" href="?page=${totalPages}&limit=${pageSize}" aria-label="Last">
